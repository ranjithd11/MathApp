    ...
    <>
      <div className={`problem-card ${status} ${timedOut ? 'timed-out' : ''}`}>
        ...
        <div className="numpad-row">
          ...
          {/* Side button: Check / Next */}
          {isAnswerable ? (
            <button
              className="side-btn check"
              onClick={handleCheck}
              disabled={userAnswer === ''}
              aria-label="Check answer (or press Enter)"
            ...
            <button
              ...
              onClick={handleNext}
              aria-label="Next question (or press Enter)"
              title="Next Question (Enter ↵)"
            >
              <span className="side-btn-icon">▶</span>
